                ...
                <tbody class="divide-y divide-slate-100">
                    <template x-for="client in filteredClients" :key="client.id">
                        <tr class="hover:bg-[#F4F8FC]/50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4">
                                {{-- Nombre del Plan (Muestra el activo, o el último que expiró) --}}
                                <p class="font-black text-[#1E55AA]" x-text="client.subscription_name || 'Sin suscripción'"></p>

                                <template x-if="client.end_subscription">
                                    <div class="mt-1">

                                        {{-- ESCENARIO A: El contrato está Activo y Vigente --}}
                                        <template x-if="client.has_active_subscription">
                                            <p class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-emerald-50 border border-emerald-100 text-[11px] font-black text-emerald-600 tracking-wide uppercase">
                                        ...
                                        {{-- ESCENARIO B: El contrato ya Caducó / Expiró --}}
                                        <template x-if="!client.has_active_subscription">
                                            <p class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-rose-50 border border-rose-100 text-[11px] font-black text-rose-600 tracking-wide uppercase">
