                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="p-5 pr-6 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <button @click="openViewModal(item, 'subscriptions')" class="p-2 rounded-xl text-[#1E55AA]/40 hover:text-[#1E55AA] hover:bg-[#F4F8FC] transition-colors" title="Ver Detalles">
